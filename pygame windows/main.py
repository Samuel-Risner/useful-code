...
from settings import SCREEN_INIT_WIDTH, SCREEN_INIT_HEIGHT, GAME_NAME, FPS, FPS_IDLE
import screens
...
CANVAS = pygame.Surface((SCREEN_INIT_WIDTH, SCREEN_INIT_HEIGHT))

CANVAS_SCALE = [SCREEN_INIT_WIDTH, SCREEN_INIT_HEIGHT]
CANVAS_POS = [0, 0]

pygame.display.set_caption(GAME_NAME)
screen = pygame.display.set_mode((SCREEN_INIT_WIDTH, SCREEN_INIT_HEIGHT), pygame.RESIZABLE)

fullscreen = False
window_width = SCREEN_INIT_WIDTH
window_height = SCREEN_INIT_HEIGHT
