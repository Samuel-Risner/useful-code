...
from settings import WINDOW_INIT_WIDTH, WINDOW_INIT_HEIGHT, WINDOW_MIN_WIDTH, WINDOW_MIN_HEIGHT, FULLSCREEN_KEYS
...
class Window():
    ...
    def on_size_change(self):
        ...
        h_rel = WINDOW_INIT_WIDTH / WINDOW_INIT_HEIGHT
        w_rel = WINDOW_INIT_HEIGHT / WINDOW_INIT_WIDTH
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.VIDEORESIZE:
                    if not self.fullscreen:
                        ...
                        if self.window_width < WINDOW_MIN_WIDTH:
                            self.window_width = WINDOW_MIN_WIDTH
                        if self.window_height < WINDOW_MIN_HEIGHT:
                            self.window_height = WINDOW_MIN_HEIGHT
